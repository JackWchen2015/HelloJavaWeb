...
public class CustomerServlet extends BaseServlet {
    ...
    public String add(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("msg", "恭喜，成功添加会员");
        return "/msg.jsp";
    }
    ...
    private String getUrl(HttpServletRequest request) {
        ...
        System.out.println("sql+url:"+contextPath + servletPath + "?" + queryString);
    ...
    public String edit(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("msg", "恭喜，编辑会员成功");
        return "/msg.jsp";
    }
    public String delete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String id = request.getParameter("id");
        customerService.delete(id);
        request.setAttribute("msg", "恭喜，删除会员成功");
        return "/msg.jsp";
    }
    public String batchAdd(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

        customerService.batchAdd();
        request.setAttribute("msg", "恭喜，批量添加会员成功");
        return "/msg.jsp";
    }
